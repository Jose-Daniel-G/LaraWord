        ...
        @if (count($posts) > 0)
            @foreach ($posts as $post)
                <div class="col-md-6 d-flex align-items-stretch">
                    <div class="card card-outline card-primary mb-4 w-100 d-flex flex-column justify-content-between shadow-sm">
                        ...
                        @else
                            ...
                            <div class="bg-gradient-secondary text-center d-flex align-items-center justify-content-center" style="height: 220px; width: 100%;">
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-tools d-flex align-items-center flex-wrap justify-content-end">
                                ...
                                <span class="badge badge-info px-2 py-1 shadow-sm my-1">
                                    <i class="far fa-calendar-alt mr-1 small"></i>{{ \Carbon\Carbon::parse($post['date'])->format('d/m/Y') }}
                                </span>
                            </div>
                        </div>
        ...
        @else
            ...
            <div class="col-md-12">
                <div class="alert alert-warning shadow">
                    ...
                    Verifica que tengas posts publicados en tu administrador de <a href="http://miwordpress.test/wp-admin/" target="_blank" class="text-dark text-underline"><b>WordPress</b></a> o comprueba que la variable <code>WORDPRESS_API_URL</code> apunte correctamente en tu archivo <code>.env</code>.
                </div>
            </div>
        @endif
    </div>
